...
import com.fintechplatform.ui.cashin.models.CashInReply
...
class CashInPresenterTest {

    lateinit var presenter: CashInPresenter

    @Mock lateinit var view: CashInContract.View
    ...
    @Captor lateinit var callbackCaptor: ArgumentCaptor<(CashInReply?, Exception?) -> Unit>
    ...
    fun setUp() {
        ...
        presenter = CashInPresenter(config, view, api, moneyHelper, BalanceHelper(balancePersistence, balanceAPI), feeHelper)
    }
   ...
   fun onConfirmWithCardDataServerNoData() {
     ...
     fun onConfirmWithCardDataServerWithSecureCode() {
         ...
         /* Callback test */
         // Given
         val payinReply = CashInReply("123", true, "http://www.example.com")
    ...
    fun onConfirmWithCardDataServerPayInSuccess() {
        ...
        /* Callback test */
        // Given
        val payinReply = CashInReply("123", false, null)
