...
@Singleton
@Component(modules = [EnterpriseContactsPresenterModule::class, AlertHelpersModule::class, EnterpriseAPIModule::class, NetModule::class, EnterprisePersistanceDBModule::class, LogModule::class])
