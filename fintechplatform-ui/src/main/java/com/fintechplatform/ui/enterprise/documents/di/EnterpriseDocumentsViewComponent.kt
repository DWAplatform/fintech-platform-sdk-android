...
@Singleton
@Component(modules = [EnterpriseDocumentsPresenterModule::class, EnterpriseAPIModule::class, IdsDocumentsAPIModule::class, NetModule::class, ImageHelperModule::class, AlertHelpersModule::class, EnterpriseDocumentsPersistanceDBModule::class, LogModule::class])
