...
open class BalanceHelper @Inject constructor(val persistence: BalancePersistence,
    ...
    fun getAndUpdateCachedBalance(token: String, userId: String, accountId: String, accountType: String, tenantId: String, callback: (BalanceItem?, Exception?) -> Unit): Money {
