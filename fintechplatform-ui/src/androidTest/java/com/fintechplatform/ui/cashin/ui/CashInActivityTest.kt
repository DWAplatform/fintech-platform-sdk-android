...
import com.fintechplatform.ui.cashin.CashInUIMockViewComponent
import com.fintechplatform.ui.secure3d.ui.Secure3DActivity
...
class CashInActivityTest {

    @Rule @JvmField val main = ActivityTestRule(CashInActivity::class.java, false, false)
    @Rule @JvmField val uiThreadTestRule = UiThreadTestRule()

    @Before fun setup() {
        CashInUIMockViewComponent()
    }
