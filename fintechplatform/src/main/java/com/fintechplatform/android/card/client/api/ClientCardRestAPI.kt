...
open class ClientCardRestAPI constructor(
    ...
    private fun createRequestError(volleyError: VolleyError): ClientCardAPI.APIReplyError {
        ...
        try {
            ...
            return ClientCardAPI.APIReplyError(jsonHelper.buildJSONArray(jsonString), volleyError)
        } catch(e: JSONException) {
            return ClientCardAPI.APIReplyError(null, volleyError)
        }
    }
            ...
            val request = requestProvider.jsonObjectRequest(Request.Method.GET, url, null,
                    { response ->
                        try {
                            ...
                            completionHandler(null, ClientCardAPI.ParseReplyParamsException(e))
                        }
