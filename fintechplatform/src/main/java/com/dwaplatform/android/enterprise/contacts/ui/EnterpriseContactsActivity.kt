 ...
 */
class EnterpriseContactsActivity : AppCompatActivity(), EnterpriseContactsContract.View {

    @Inject lateinit var presenter: EnterpriseContactsContract.Presenter
    @Inject lateinit var alertHelper: AlertHelpers

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        EnterpriseContactsUI.instance.createContactsComponent(this as Context, this).inject(this)
